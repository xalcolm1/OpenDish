...
reservation1 = Reservation.create!(
    ...
    date: (DateTime.new(2021,1,26,13,51,50).to_f * 1000).to_i,
    people: 2
)
reservation2 = Reservation.create!(
    user_id: user1.id,
    restaurant_id: restaurant9.id,
    date: (DateTime.new(2021,2,23,13,51,50).to_f * 1000).to_i,
    people: 4
)
reservation3 = Reservation.create!(
    user_id: user1.id,
    restaurant_id: restaurant20.id,
    date: (DateTime.new(2021,2,28,13,51,50).to_f * 1000).to_i,
    people: 2
)
reservation4 = Reservation.create!(
    user_id: user1.id,
    restaurant_id: restaurant11.id,
    date: (DateTime.new(2021,2,20,13,51,50).to_f * 1000).to_i,
    people: 8
)
reservation5 = Reservation.create!(
    user_id: user1.id,
    restaurant_id: restaurant18.id,
    date: (DateTime.new(2021,8,26,13,51,50).to_f * 1000).to_i,
    people: 2
)
reservation6 = Reservation.create!(
    user_id: user1.id,
    restaurant_id: restaurant29.id,
    date: (DateTime.new(2021,4,20,13,51,50).to_f * 1000).to_i,
    people: 10
)
